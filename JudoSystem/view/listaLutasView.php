              ...
              <tbody id="bodyTable">
                  ...
                  ?>
                      <tr id="<?=$l->getIdLutas()?>">
                        ...
                        <td><a href="index.php?class=Lutas&method=showUpdate&id_lutas=<?php echo $l->getIdLutas() ?>&comp=<?=$_GET['comp']?>&categoria=<?=$_GET['categoria']?>"><button type="button" class="btn btn-info" id="btnMod">Detalhar lutas</button></a></td>
                        <td><button id="btnDel" class="btn btn-danger" onclick="deletaLuta(<?php echo $l->getIdLutas() ?>)">Deletar</button></td>
                      </tr>
                  <?php
                      }
                  ?>
